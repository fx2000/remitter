			...
			<thead>
			 ...
			 <tbody>
 				...
 				?>
						...
						<td><?php echo ($account['trans_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['sale_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['retailer_sale_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['store_sale_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['user_sale_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['account_inventory_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['account_movement_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['account_deposit_report']==1)?'Yes':'No';?></td>
						<td><?php echo ($account['time']==1)?'Daily':'Weekly';?></td>
                                               
						<td class="center">
							<?php 
									echo $this->html->link('<i class="icon-edit icon-black"></i><span class="hidden-phone">Edit</span> ',array('controller'=>'Setting','action'=>'report_setting',base64_encode($account['id'])),array('class'=>'btn btn-small','escape'=>false));
									echo $this->html->link('<i class="icon-trash icon-black"></i><span class="hidden-phone">Delete</span> ',array('controller'=>'Setting','action'=>'delete_report_setting',base64_encode($account['id'])),array('class'=>'btn btn-small','escape'=>false));
