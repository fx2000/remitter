...
<div class="row-fluid ">	
		<div class="box span12">
			...
			<div class="box-content">
				 <?php echo $this->Form->create('',array('url'=>array('controller'=>'Setting','action'=>'retailerDeveloper'),'class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
			         <fieldset>
			 ...
			 <tbody>
 				...
 				?>
                        <tr>
							...
							<td><?php echo $account['Developer']['developer_key'];?></td>
							<td><?php echo $account['Developer']['secret_key'];?></td>
                                               
							<td class="center">
								<?php 
										echo $this->html->link('<i class="icon-trash icon-black"></i><span class="hidden-phone">Delete</span> ',array('controller'=>'Setting','action'=>'delete_developer',base64_encode($account['Developer']['id'])),array('class'=>'btn btn-small del_rec','escape'=>false));	
									?>
							 </td>
						</tr>	
                                <?php }
