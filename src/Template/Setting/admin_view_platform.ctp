			...
			<thead>
			 ...
			 <tbody>
 				...
 				?>
						...
						<td class="center">
							<?php echo $this->html->link('<i class="icon-edit icon-black"></i><span class="hidden-phone">Edit</span> ',array('controller'=>'Setting','action'=>'edit_platform',base64_encode($cred['Operator']['id'])),array('class'=>'btn btn-small','escape'=>false))?>
                                                        <?php echo $this->html->link('<i class="icon-edit icon-black"></i><span class="hidden-phone">Change Password</span> ',array('controller'=>'setting','action'=>'change_password',base64_encode($cred['Operator']['id'])),array('class'=>'btn btn-small','escape'=>false));?>
                                                 </td>
					</tr>	
                                <?php }
				  }	
