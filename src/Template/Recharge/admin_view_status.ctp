		...
		<div class="box-content">
			 <?php echo $this->Form->create('',array('url'=>array('controller'=>'recharge','action'=>'generateNewRecharge'),'class'=>'form-horizontal'));?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<span style="margin-top: 6px;float: left;" ><?php echo $rechageStaus['Recharge']['reference_no'];?></span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Mobile No.</label>
					<div class="controls">
						<span style="margin-top: 6px;float: left;" ><?php echo $rechageStaus['Recharge']['mobile_no'];?></span>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<span style="margin-top: 6px;float: left;" ><?php echo date('d M, Y',strtotime($rechageStaus['Recharge']['datetime']));?></span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Status</label>
					<div class="controls">
						<span style="margin-top: 6px;float: left;" ><?php echo ($rechageStaus['Recharge']['status']==1)?'Success':'Failed';?></span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Message</label>
					<div class="controls">
						<span style="margin-top: 6px;float: left;" ><?php echo $rechageStaus['Recharge']['response_msg'];?></span>
					</div>
				</div>
			</fieldset>
