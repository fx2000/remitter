...
<div>
	<ul class="breadcrumb">
		...
		<li>/</li>
		<li>
			<?php echo 'Edit Airtime Movement Detail'?>
		</li>
	</ul>
</div>
...
<div class="row-fluid ">	
		<div class="box span12">
		       <div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i>Edit Airtime Movement Detail</h2>
		        </div>
				 ...
				 <?php echo $this->Form->create('',array('url'=>array('controller'=>'inventory','action'=>'airtime_movement_confirm'),'class'=>'form-horizontal','onload'=>'loadDefaultSource()'));?>
			         <fieldset>
								  ...
								  <label class="control-label">Movement Type</label>
								   <div class="controls">
									<label class="radio">
										<input type="radio" name="data[AirtimeMovement][movement_type]" id="movement1" onclick="loadSource()" value="1" <?php echo $this->request->data['AirtimeMovement']['movement_type']==1?'checked':''?>>
										Retailer To Store
									</label>
									<div style="clear:both"></div>
									<label class="radio">
										<input type="radio" name="data[AirtimeMovement][movement_type]" id="movement2" onclick="loadSource()" value="2" <?php echo $this->request->data['AirtimeMovement']['movement_type']==2?'checked':''?>>
										Store To Retailer
									</label>
								  </div>
                                                        </div>
								  ...
								  <label class="control-label">Source</label>
								   <div class="controls" style="float:left;margin-left:25px;">
									<?php echo $this->Form->input('AirtimeMovement.source_id', array('type' => 'select','options'=>$source,'empty'=>'Select Source','id'=>"source",'label'=>false,'onchange'=>'loadAccount()'))?>
								  ...
								  <label class="control-label">Source Accounts</label>
								   <div class="controls">
									<?php echo $this->Form->input('AirtimeMovement.source_account', array('type' => 'select','options'=>$source_acct,'empty'=>'Select Account','id'=>"saccounts",'label'=>false))?>
								  ...
								  <label class="control-label">Destination</label>
								   <div class="controls" style="float:left;margin-left:25px;">
									<?php echo $this->Form->input('AirtimeMovement.destination_id', array('type' => 'select','options'=>$destination,'empty'=>'Select Destination','id'=>"destination",'label'=>false,'onchange'=>'loadDestinationAccount()'))?>
								  ...
								  <label class="control-label">Destination Accounts</label>
								   <div class="controls">
									<?php echo $this->Form->input('AirtimeMovement.destination_account', array('type' => 'select','options'=>$destination_acct,'empty'=>'Select Account','id'=>"daccounts",'label'=>false))?>
 								...
 								<script language="javascript" type="text/javascript">var f1 = new LiveValidation('amount');f1.add( Validate.Presence);f1.add( Validate.NumberValid);f1.add( Validate.SourceBalance)</script>
								  </div>
							</div>
                                                         <div class="control-group">
								  ...
								  <label class="control-label">Notes</label>
								   <div class="controls">
								    <?php echo $this->Form->input('AirtimeMovement.notes',array('type'=>'text','class'=>'input-large ','id'=>'notes','div'=>false,'label'=>false,'data-rel'=>'tooltip','data-original-title'=>'Notes'));?>
                                     ...
                                     <input type="hidden" id="available_amount" value="<?php echo $this->request->data['AirtimeMovement']['source_account_amt']?>">
