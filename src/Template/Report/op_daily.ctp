...
<div class="row-fluid ">        
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h4><i class="fas fa-paper-plane"></i><?php echo __(' Cierre de Caja - ') . $staff; ?></h4>
        </div>
            ...
            <div class="card-body">
                <div class="author">
                    <div class="content">
                        ...
                        <div>
                            <table class="table" align="center">
                                <tr><td style="text-align:center;font-family:Calibri;font-size:14pt;"><strong>CIERRE DIARIO</strong></td></tr>
                                <tr><td style="text-align:center;font-family:Calibri;font-size:12pt;"><?php echo $date?></td></tr>
                                <hr/>
                            </table>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <hr/>
                                <?php
                                    ...
                                    echo ('<tr><td align="right"><b>'.__('Reporte Generado').'</b></td><td align="left">'.date('Y-m-d h:i a').'</td></tr>');
