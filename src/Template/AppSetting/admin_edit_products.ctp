...
<div class="row-fluid ">	
		<div class="box span12">
			...
			<div class="box-content">
				 <?php echo $this->Form->create('',array('url'=>array('controller'=>'AppSetting','action'=>'edit_products',$this->request->params['pass'][0]),'class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
			         <fieldset>
