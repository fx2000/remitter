...
<div class="row-fluid ">	
		<div class="box span12">
			...
			<div class="box-content">
				 <?php echo $this->Form->create('',array('url'=>array('controller'=>'AppSetting','action'=>'add_slideshow_img'),'class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
			         <fieldset>
							<div class="control-group">
								  <label class="control-label">Choose image</label>
								   <div class="controls">
								    <input type="file" id="file" name="data[Slideshow][file]" class="file" >
