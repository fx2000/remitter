...
<div class="row-fluid ">	
		<div class="box span12">
		       <div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i> Add Product</h2>
		        </div>
			<div class="box-content">
				 <?php echo $this->Form->create('',array('url'=>array('controller'=>'AppSetting','action'=>'add_product'),'class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
			         <fieldset>
							...
							<div class="control-group">
 								...
 								<script language="javascript" type="text/javascript">var f1 = new LiveValidation('amount');f1.add( Validate.Presence);f1.add( Validate.NumberValidFloat)</script>
								  ...
								  <label class="control-label">Choose Barcode Image</label>
								   <div class="controls">
								    <input type="file" id="barcodeimg" name="data[Product][file]" class="file" >
