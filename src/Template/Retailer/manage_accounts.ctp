			         ...
			         <fieldset>
								  ...
								  <label class="control-label">Account Type</label>
								   <div class="controls">
                                                                   ...
                                                                   ?>
									<label class="radio">
										<input type="radio" name="Account[account_type]" onclick="ShowField()" id="account1" value="1" <?php echo ($this->request->data['Account']['account_type']==1)?'checked=true':''?>   > 
										Postpaid
									</label>
									<div style="clear:both"></div>
                                                                        ...
                                                                        ?>
									<label class="radio">
										<input type="radio" name="Account[account_type]" onclick="ShowField()" id="account2" value="2" <?php echo ($this->request->data['Account']['account_type']==2)?'checked=true':''?> <?php echo ($this->request->data['Account']['account_type']=='')?'checked=true':''?>>
										Prepaid
									</label>
								  </div>
                                                        </div>
...
<div class="row-fluid ">		
		<div class="box span12">
		     <div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i><?php echo ' Retailer <b>'.$retailer->name;?></b> Accounts</h2>
		      </div>
		<div class="box-content">
