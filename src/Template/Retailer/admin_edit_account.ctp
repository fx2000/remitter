...
<div class="row-fluid ">	
		<div class="box span12">
			...
			<div class="box-content">
				 <?php echo $this->Form->create('',array('url'=>array('controller'=>'Retailer','action'=>'edit_account',$this->request->params['pass'][0]),'class'=>'form-horizontal'));?>
			         <fieldset>
                                     <?php 
								  ...
								  <label class="control-label">Account Type</label>
								   <div class="controls">
									<label class="radio">
                                                                        ...
                                                                        {
                                                                   ?>
										<input type="radio" name="data[Account][account_type]" onclick="ShowField()" id="account1" value="1" <?php echo ($this->data['Account']['account_type']==1)?'checked=true':''?> <?php echo ($this->data['Account']['account_type']=='')?'checked=true':''?>  > 
										Postpaid
									</label>
									<div style="clear:both"></div>
                                                                        ...
                                                                        ?>
									<label class="radio">
										<input type="radio" name="data[Account][account_type]" onclick="ShowField()" id="account2" value="2" <?php echo ($this->data['Account']['account_type']==2)?'checked=true':''?> >
										Prepaid
									</label>
								  </div>
                                                        </div>
