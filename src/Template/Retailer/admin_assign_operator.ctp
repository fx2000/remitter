...
<div class="row-fluid ">	
		<div class="box span12">
			...
			<div class="box-content">
				 <?php echo $this->Form->create('',array('url'=>array('controller'=>'Retailer','action'=>'assign_operator',$this->request->params['pass'][0]),'class'=>'form-horizontal'));?>
			         <fieldset>
								  ...
								  <div class="controls">
									<label class="radio">
                                                                            <input type="checkbox" name="data[AccountOperator][operator_id][]" id="operator<?php echo $operator['Operator']['id']?>" value="<?php echo $operator['Operator']['id']?>" class="operator"> 
		...
		<div class="box-content">
			...
			<thead>
			 ...
			 <tbody>
 				...
 				?>
                                            <tr>
                                                <td><?php echo $all_operators[$account_operator['AccountOperator']['operator_id']];?></td>
                                                <td class="center">
                                                    <?php echo $this->html->link('<i class="icon-edit icon-black"></i><span class="hidden-phone">Delete</span> ',array('controller'=>'Retailer','action'=>'delete_account_operator',base64_encode($account_operator['AccountOperator']['id'])),array('class'=>'btn btn-small del_rec','escape'=>false));?>
                                                </td>
                                            </tr>	
                                <?php 
                                        }
